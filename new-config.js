...
const config = {
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          },
          {
            ...
            position: 'left', // 左对齐
            items: [
              {label: '子菜单 1', to: '/docs/core-board/submenu-1'},
      ...
      // 修改搜索框
      algolia: {
        appId: 'YourAppId', // 替换为你自己的 Algolia appId
        apiKey: 'YourSearchOnlyApiKey', // 替换为你自己的搜索API密钥
        indexName: 'your-index-name', // 替换为你自己的索引名称
      },
    }),
};
